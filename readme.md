...
Так как я собрался хранить пароли, то для моих целей получился код

0x0F 0x00 0xFF

что означает:

* Читать и записывать все блоки данных по ключу B
* Читать и записывать trailer по ключу B
* Ключ A не имеет прав.
* Если, не знать ключа B, хранимая информация в секторе будет недоступна
* Смена ключа возможно только для ключа B

При смене ключа надо быть предельно осторожным, я умудрился запороть 4 сектора на брелоке и два сектора на карте перепутав название буфера, благодаря чему писал в трейлер Hello World вместо информации о пароле =\ Интересно какие права доступа теперь будут для значения 'orl' =) Может есть еще шанс спасти утраченное.
